...
%  M50 = reshape(M49,1,size(M49,1)*size(M49,2))
  
%  M51 = sort(M50,2)
  
%  M52 = reshape(M51,size(M49,2),size(M49,1))
...
% Pour la multiplication de deux matrice ( Ma * Mb ), Ma doit avoir autant de colonne que Mb a de ligne
